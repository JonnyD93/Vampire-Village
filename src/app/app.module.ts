...
@NgModule({
  ...
  providers: [AbilitiesService, AccountService, DataService, EffectsService, FakeDataService,GameService, ItemsService, Location, {provide: LocationStrategy, useClass: HashLocationStrategy}],
